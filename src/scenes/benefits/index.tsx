...
const benefits: Array<BenefitType> = [
  ...
  },
  {
    ...
    description:
      "Nuestro equipo de expertos está comprometido en brindarte la asistencia necesaria para alcanzar tus metas. Te ofrecemos asesoramiento personalizado y rutinas diseñadas específicamente para tu entrenamiento de musculación.",
  },
  {
    icon: <AcademicCapIcon className="h-6 w-6" />,
    title: "Entrenadores especializados",
    description:
      "Contamos con entrenadores profesionales y altamente capacitados en el entrenamiento de musculación. Ellos te guiarán en cada paso del camino, asegurándose de que realices los ejercicios de manera correcta y segura. ¡Entrena con los mejores para obtener resultados óptimos!",
  },
];
